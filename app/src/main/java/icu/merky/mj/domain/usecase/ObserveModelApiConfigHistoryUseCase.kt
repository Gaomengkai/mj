...
class ObserveModelApiConfigHistoryUseCase @Inject constructor(
    private val modelApiConfigRepository: ModelApiConfigRepository
) {
    operator fun invoke(): Flow<List<ModelApiConfigHistoryEntry>> {
        return modelApiConfigRepository.observeSuccessHistory()
    }
}
